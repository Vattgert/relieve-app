...
const UpvoteItem = ({ vote }) => {
    ...
    const average = (hostEvaluation + contentEvaluation + satisfactionEvalution + valueForMoneyEvaluation ) / 4;
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.votes}>
                ...
                <VoteCircle grade={contentEvaluation} position={"content"} text={"Content"}/>
                <VoteCircle grade={satisfactionEvalution} position={"satisfaction"} text={"Satisfaction"}/>
                <VoteCircle grade={valueForMoneyEvaluation} position={"valueForMoney"} text={"Value for money"}/>
